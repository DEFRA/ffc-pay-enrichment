jest.mock('../../../../app/enrichment/es/get-fund-code')
const { getFundCode: mockGetFundCode } = require('../../../../app/enrichment/es/get-fund-code')

jest.mock('../../../../app/enrichment/es/get-marketing-year')
const { getMarketingYear: mockGetMarketingYear } = require('../../../../app/enrichment/es/get-marketing-year')

jest.mock('../../../../app/enrichment/es/get-account-code')
const { getAccountCode: mockGetAccountCode } = require('../../../../app/enrichment/es/get-account-code')

const { DRD05 } = require('../../../../app/constants/fund-codes')
const { SOS710 } = require('../../../../app/constants/account-codes')

const { enrichInvoiceLine } = require('../../../../app/enrichment/es/enrich-invoice-line')
