const { SFI, SFI_PILOT, LUMP_SUMS, CS, BPS, FDMR, MANUAL, ES, FC, IMPS, SFI23, DELINKED, COMBINED_OFFER, COHT_CAPITAL } = require('../../constants/schemes')
...
const createInvoiceNumber = (paymentRequest) => {
  ...
  try {
    const standardSchemeInvoices = new Set([DELINKED, COMBINED_OFFER, COHT_CAPITAL])
